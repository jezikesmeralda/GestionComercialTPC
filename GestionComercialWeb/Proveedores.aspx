...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card shadow-sm">
     ...
     <div class="mb-3 mt-3">
     <asp:Button ID="btnVerInactivos" runat="server" Text="Ver Proveedores Inactivos"
 ...
 <asp:Panel ID="pnlInactivos" runat="server" Visible="false" CssClass="card shadow-sm">
     <div class="card-body">
         <h5 class="mb-3">Proveedores Inactivos</h5>
    ...
    <div class="modal fade" id="modalReactivar" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Seguro que desea reactivar este proveedor?
